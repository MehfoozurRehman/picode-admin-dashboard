...
function CustomersDetailsTableEntry({ onView, onEdit, onDelete }) {
  return (
...
export default function CustomersDetails({ onAdd, onEdit, onDelete }) {
    ...
    <div className="main">
      <div className="main__header">
        <div className="main__header__top">
          <div className="main__header__top__heading">Customer Details</div>
      ...
      >
        <div className="main__content__form" style={{ paddingBottom: 0 }}>
          {/* <div
